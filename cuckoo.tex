...
The right plot shows in green the speedup achieved by up to 40 threads on a dual Intel Xeon with
10 hyperthreaded cores each.
...
memory requests faster by reducing the number of rounds in \phash. This produced some unexpected
