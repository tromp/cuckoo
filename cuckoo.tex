...
which memory latency dominates the runtime, promoting investment in low-power general purpose
hardware (DRAM) rather than single purpose high-power hardware.
More research is needed to determine the effectiveness of GPUs for running Cuckoo Cycle.
