...
consider a tradeoff infeasible if it incurs an order of magnitude increase
...
Note that the above properties should apply only to mining, not to proof verification,
...
Instead we will present an efficient proof-finding algorithm,
