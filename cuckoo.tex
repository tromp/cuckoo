...
based on finding cycles on large random graphs.
Such problems are arbitrarily scalable trivially verifiable.
Our implementation requires the use of 1 bit per edge.
...
Fix an (even) number of nodes $8 \leq N < 2^{64}$, a number of edges $N/4 < E
\leq N$, and an (even) cycle length $4 \leq L < N$.
Function $\cuckoo$ maps any 128-bit key $k$ (the header digest) to a
bipartite graph $G = (V_0 \cup V_1, E)$, where $V_0$ and $V_1$ are disjoint
set of integers modulo $N/2$, and $E$ has an edge between $\hash(k,2*n) \bmod \frac{N}{2}$
in $V_0$ and $\hash(k,n) \bmod \frac{N}{2}$ in $V_1$
for every nonce $0 \leq n < E$. A proof for $G$ is a subset of
...
(1,1.000) (2,1.186) (3,1.618) (4,2.449) (5,2.899) 
(6,3.247) (7,3.326) (8,3.468) (9,3.661) (10,3.797) 
(11,3.927) (12,4.961) (13,5.153) (14,5.299) (15,5.271) 
(16,5.264) (17,5.208) (18,5.228) (19,5.219) (20,8.689) 
};
\addlegendentry{ketchup30}
\addplot [color=blue] coordinates {
(1,1.000) (2,1.361) (3,1.845) (4,2.758) (5,3.260) 
(6,3.684) (7,3.848) (8,4.056) (9,4.289) (10,4.500) 
(11,4.657) (12,5.774) (13,5.999) (14,6.219) (15,6.211) 
(16,6.275) (17,6.329) (18,6.333) (19,6.346) (20,9.964) 
};
\addlegendentry{ketchup30.1}
