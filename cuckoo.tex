...
introduced by Tenebrix~\cite{tenebrix2011}---since faded into obscurity---and
...
This is best achieved by making main memory latency a bottleneck, since
...
Note that the above properties apply only to mining, not to proof verification,
which ideally requires negligable memory and time.
Thus, we aim for a highly assymetric design. A final aim is to keep the design very simple.
