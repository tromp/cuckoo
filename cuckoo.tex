...
A cycle of length 2 means that two nonces produce the same edge; a {\em collision} in edge space.
The Momentum proof-of-work, which looks for collisions on 50 bits of 
% in progress
