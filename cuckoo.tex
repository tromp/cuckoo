...
As we will demonstrate, Momentum is in essence a special case of Cuckoo Cycle.
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[xlabel={E/N in \%}, ylabel={\% runtime}, legend pos=north west]
\addplot[color=blue] coordinates {
...
The ratio $E/N$ determines a base level of difficulty,
...
The implementation default $E/N=\frac{1}{2}$ gives a solution probability of roughly $2.2\%$,
...
This works whenever $E/N \leq \frac{1}{2}$ since the expected degree of a node is then at most 1,
...
For cycle lengths under 12, the BFS($L/2$) algorithm is superior while 
