...
cuckoo:		cuckoo.h cuckoo_solve.h cuckoo.c Makefile
	cc -o cuckoo -DSHOW -DPROOFSIZE=6 -DSIZEMULT=1 -DSIZESHIFT=4 cuckoo.c ${FLAGS}

example:	cuckoo
	./cuckoo -e 100 -h header

cuckoo110:	cuckoo.h cuckoo_solve.h cuckoo.c Makefile
	cc -o cuckoo110 -DSIZEMULT=1 -DSIZESHIFT=10 cuckoo.c ${FLAGS}

cuckoo115:	cuckoo.h cuckoo_solve.h cuckoo.c Makefile
	cc -o cuckoo115 -DSIZEMULT=1 -DSIZESHIFT=15 cuckoo.c ${FLAGS}

cuckoo120:	cuckoo.h cuckoo_solve.h cuckoo.c Makefile
...
cuckoo125:	cuckoo.h cuckoo_solve.h cuckoo.c Makefile
	cc -o cuckoo125 -DSIZEMULT=1 -DSIZESHIFT=25 cuckoo.c ${FLAGS}

cuckoo128:	cuckoo.h cuckoo_solve.h cuckoo.c Makefile
...
cuckoo130:	cuckoo.h cuckoo_solve.h cuckoo.c Makefile
