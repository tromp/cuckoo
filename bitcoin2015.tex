...
A \alert{proof-of-work} (PoW) system allows a verifier to check with negligible
...
\item achieving consensus in crypto currencies
\end{itemize}
\end{frame}
...
for some fixed hash function $H$ and notion of many.
...
design arms race to drive down performance per Watt, rapid hardware obsolescence,
